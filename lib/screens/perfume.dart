...
class Perfume extends StatefulWidget {
  ...
  @override
  State<Perfume> createState() => _MenState();
}

class _MenState extends State<Perfume> {
  ...
  Future<void> fetchProducts() async {
    try {
      final response = await http.get(Uri.parse("http://127.0.0.1:3001/shop_product/perfume"));
